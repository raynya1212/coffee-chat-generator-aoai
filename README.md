...
- **場の設定を明確化**: 参加者の職種（エンジニア、PM、デザイナー等）やカジュアルな雰囲気を伝達
...
- **AI**: Azure OpenAI (`openai` sdk) using GPT-4.1 mini
- **Fonts**: `@next/font/google` (Capriola, Yomogi)
- **Animations**: `@lottiefiles/dotlottie-react` + Azure-themed glow effects
